...
const Admintopup = () => {
  ...
  const handlejio = async() => {
    ...
    try{
      const response1 = await AdminService.rechageplans(localStorage.getItem('token'), "jio","1", "topup");
      setGb1(response1.data);

      const response1_5 = await AdminService.rechageplans(localStorage.getItem('token'), "jio","1.5", "topup");
  ...
  const handleairtel = async() => {
    ...
    try{
      const response1 = await AdminService.rechageplans(localStorage.getItem('token'), "airtel","1", "topup");
      setGb1(response1.data);

      const response1_5 = await AdminService.rechageplans(localStorage.getItem('token'), "airtel","1.5", "topup");
      setGb1_5(response1_5.data);

      const response2 = await AdminService.rechageplans(localStorage.getItem('token'), "airtel","2", "topup");
      setGb2(response2.data);
      console.log(response1.data);
    }
    catch(e) {
  ...
  const handlevi = async() => {
    ...
    try{
      const response1 = await AdminService.rechageplans(localStorage.getItem('token'), "vi","1", "topup");
      setGb1(response1.data);

      const response1_5 = await AdminService.rechageplans(localStorage.getItem('token'), "vi","1.5", "topup");
      setGb1_5(response1_5.data);

      const response2 = await AdminService.rechageplans(localStorage.getItem('token'), "vi","2", "topup");
      setGb2(response2.data);
      console.log(response1.data);
    }
    catch(e) {
